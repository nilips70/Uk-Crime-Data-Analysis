...
# reading the stop-and-search dataset for manchester (3 years)
temp_ss <- list.files(path = paste0(getwd(), "/manchester 3yrs data"), pattern = "*search.csv")
temp_ss <- paste0(getwd(), "/manchester 3yrs data/", temp_ss)
...
temp_st <- list.files(path = paste0(getwd(), "/manchester 3yrs data"), pattern = "*street.csv")
temp_st <- paste0(getwd(), "/manchester 3yrs data/", temp_st)
...
# saveRDS(df_st, "manchester_st.rds")
...
# saveRDS(df_ss, "manchester_ss.rds")