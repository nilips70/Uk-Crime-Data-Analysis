...
# reading the stop-and-search dataset for merseyside 3yrs data  (3 years)
temp_ss <- list.files(path = paste0(getwd(), "/merseyside 3yrs data"), pattern = "*search.csv")
temp_ss <- paste0(getwd(), "/merseyside 3yrs data/", temp_ss)
...
temp_st <- list.files(path = paste0(getwd(), "/merseyside 3yrs data"), pattern = "*street.csv")
temp_st <- paste0(getwd(), "/merseyside 3yrs data/", temp_st)
...
# saveRDS(df_st, "merseyside_st.rds")
...
# saveRDS(df_ss, "merseyside_ss.rds")