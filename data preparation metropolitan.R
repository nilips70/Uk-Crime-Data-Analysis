...
# reading the stop-and-search dataset for Metropolitan police service 3yrs data  (3 years)
temp_ss <- list.files(path = paste0(getwd(), "/Metropolitan police service 3yrs data"), pattern = "*search.csv")
temp_ss <- paste0(getwd(), "/Metropolitan police service 3yrs data/", temp_ss)
...
temp_st <- list.files(path = paste0(getwd(), "/Metropolitan police service 3yrs data"), pattern = "*street.csv")
temp_st <- paste0(getwd(), "/Metropolitan police service 3yrs data/", temp_st)
...
# saveRDS(df_st, "metropolitan_st.rds")
...
# saveRDS(df_ss, "metropolitan_ss.rds")